...
#define MAG_INTERFACE_V30_MODE_STANDARD                     0                   // only 2 modi are implemented yet, rest reserved for future use
#define MAG_INTERFACE_V30_MODE_TIMESTAMP_SYNCH              (1 << 1)
